 ...
 * Search addresses
 */
export const searchAddresses: RequestHandler = asyncHandler(
	async (req: Request, res: Response<ApiResponse<LocalizedAddress[]>>) => {
 ...
 */
export const getNearbyAddresses: RequestHandler = asyncHandler(
	async (req: Request, res: Response<ApiResponse<LocalizedAddress[]>>) => {
		const {
			latitude: latStr,
			longitude: lngStr,
 ...
 */
export const calculateDistance: RequestHandler = asyncHandler(
 ...
 */
export const formatAddress: RequestHandler = asyncHandler(
	async (
		req: Request,
